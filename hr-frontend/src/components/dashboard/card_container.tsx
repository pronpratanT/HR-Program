  ...
  return (
    <div className="w-200">
      <div className="relative pt-8 mb-6">
        ...
        <div className="absolute top-0 right-0 flex z-10">
          <button
            ...
            className={cn(
              ...
              activeTab === "summary"
                ? "bg-zinc-900 text-zinc-200 hover:text-white hover:bg-zinc-700"
                : "bg-zinc-200 text-zinc-900 shadow hover:bg-zinc-600 hover:text-white",
            )}
          >
        ...
        {/* Card Content */}
        <div className="bg-zinc-900 rounded-b-2xl rounded-tl-2xl p-6 border border-zinc-700/50">
          {activeTab === "summary" && (
            <>
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 rounded-xl bg-blue-500/15 border border-blue-500/20">
                  <TbListDetails className="text-blue-400 size-5" />
                </div>
                <div>
              ...
              <div className="mt-5 w-full mb-2 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <span className="flex items-center gap-2 text-xs font-semibold text-zinc-400 uppercase tracking-widest">
                    <span className="w-1.5 h-1.5 rounded-full bg-blue-400 inline-block" />
                    วันที่สร้างใบลา
                  </span>
                  <span className="text-sm text-white px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-800">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-800">
                    ...
                    <span className="ml-auto text-xs font-medium text-blue-400 bg-blue-500/10 border border-blue-500/20 rounded-md px-2 py-0.5">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {sampleData.file ? (
                    ...
                    <span className="text-sm text-zinc-500 px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-800">
                      ไม่มีเอกสารแนบ
                    </span>
                  )}
                </div>
          ...
          {activeTab === "leaveform" && (
            <>
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 rounded-xl bg-blue-500/15 border border-blue-500/20">
                  <VscRequestChanges className="text-blue-400 size-5" />
                </div>
                <div>
                  <h2 className="text-base font-bold text-white leading-tight">
                    สร้างใบลา
              ...
              <form className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-xl border border-zinc-700/80 bg-zinc-800/60 overflow-hidden">
                    <RangeCalendar
                      aria-label="วันที่ลา"
                      firstDayOfWeek="mon"
                    ...
                    >
                      <RangeCalendar.Header className="flex items-center justify-between px-1 pb-2 border-b border-zinc-700/50 mb-2">
                        <RangeCalendar.Heading className="text-white text-sm font-semibold" />
