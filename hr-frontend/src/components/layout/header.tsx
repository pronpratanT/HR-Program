...
function Header() {
  return (
    <div className='flex justify-center'>
      <div className='w-6xl px-5 py-3 bg-gray-950 rounded-4xl shadow-lg shadow-gray-300'>
        <div className='flex justify-between items-center w-full px-4 md:px-6 xl:px-10'>
            ...
            <div className='flex gap-3'>
                <button className='text-white hover:bg-gray-800 px-4 py-2 rounded cursor-pointer'>Dashboard</button>
                <button className='text-white hover:bg-gray-800 px-4 py-2 rounded cursor-pointer'>Export</button>
